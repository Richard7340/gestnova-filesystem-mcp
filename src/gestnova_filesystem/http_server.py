"""FastAPI HTTP wrapper for the filesystem MCP."""
...
from .tools import build_tool_registry, default_vdr
...
app = FastAPI(title="gestnova-filesystem-mcp HTTP")
_vdr = default_vdr()
_registry = build_tool_registry(_vdr)
